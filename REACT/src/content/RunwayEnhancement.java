...
public class RunwayEnhancement {
	...
	public JPanel getRun(){
		...
		runSt.setBackground(new Color(0,0,0,0));
		...
		runStTxt.setBackground(new Color(0,0,0,0));
		...
		runEd.setBackground(new Color(0,0,0,0));
		...
		runEdTxt.setBackground(new Color(0,0,0,0));
